...
public final class PromptFactory {
    private static final String PHYSICS_AND_ORIENTATION_RULES = """
                ...
                - Door openings should be capped intentionally. Do not leave accidental air gaps above doors; add a lintel, arch, beam, full-width transom window, sign, awning, or matching wall/trim directly above the doorway unless the prompt explicitly wants an open ruin.
